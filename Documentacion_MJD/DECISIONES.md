...
**⚠️ PERO NO SON LAS 5,451, SON 3,923** (corregido en la revisión del 11-ago-2026; la versión anterior de esta ficha afirmaba 5,451 y era falso). El archivo carga las órdenes de las **2 empresas activas** (Marilyn Fitness + FR Moda), porque el loader manda a `sinEmpresa` las que no tienen mapeo y **las 6 empresas viejas inactivas no migran** — decisión de Gabriel del 17-jun-2026 (MJD / Zipora / Skintex / Free Ride / Corporativo / Marilyn; ver `docs/hoja-de-ruta/F2-etapas.md`). Quedan fuera **1,528 órdenes**, y con ellas **10,510 celdas** y **9,204 movimientos de producción**. Lo que se cae es **la historia más vieja**: **1,523 de esas 1,528 son de 2005-2012** (2 de 2014 y 3 de 2016).

**PENDIENTE DE DECISIÓN DE DANIEL:** si esas 1,528 se rescatan en el archivo. Es una pregunta de negocio, no un bug: el archivo existe justo para guardar lo que no se opera, y ese tramo es el más viejo de todos. Técnicamente no basta con quitar el filtro — `HistoricoOrdenV1.idEmpresa` es **FK real a `Empresa`** y el listado filtra por la empresa activa (A9), así que rescatarlas exige decidir **a qué empresa se cuelgan** (¿el linaje de FR Moda: MJD/Corporativo/Marilyn? ¿una empresa "histórica" nueva? Zipora/Skintex/Free Ride eran negocios aparte) o cambiar el modelo. Anotado como deuda en `HOJA-DE-RUTA.md` §4; el código del loader **no se tocó** a la espera de la respuesta.
...
**Lo que se carga (medido sobre el dump, ya descontadas las empresas que no migran):** **3,923 órdenes** (de las 5,451 del viejo) · **29,356 celdas** color×talla (de 39,866) · **26,092 movimientos de producción** de los cinco documentos del viejo — corte 5,454 (de 6,967) · entregas 5,699 (de 7,334) · recibos 9,433 (de 12,440) · entregas est. 3,026 (de 4,496) · recibos est. 2,480 (de 4,059). **≈ 59,000 renglones en total** (el dump completo serían ~80,600).
...
- **No se normalizan los colores.** El viejo los guardaba como texto libre, así que conviven "MARINO", "Marino" y "MAR.". En un archivo de consulta eso se lee y se entiende; adivinar equivalencias entre ~29,000 celdas metería errores silenciosos.
