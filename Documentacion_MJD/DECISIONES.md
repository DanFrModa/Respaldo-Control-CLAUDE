...
6. **La misma factura no se recibe dos veces:** la entrada guarda el `uuidCfdi` con un unique `(idEmpresa, uuidCfdi)`, y al leer se avisa si ese UUID ya está en otra entrada **o** ya se importó a Cuentas por pagar.
