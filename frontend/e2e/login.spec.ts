...
test.describe('Inicio de sesión', () => {
  ...
  test('el admin entra y ve el layout con los 19 módulos', async ({ page }) => {
    ...
    // El admin (todos los permisos) ve los 19 links en la navegación lateral:
    // 13 módulos del plan §5 + 6 sub-vistas (galería + códigos de barra de Modelos, F1-E5;
    ...
    await expect(navegacion.getByRole('link')).toHaveCount(19);
