...
> **no código**). Desde **V1-E6b** (18-ago-2026) el sistema lo diagnostica solo: **Administración ›
> Diagnóstico del sistema** prueba el bucket desde el servidor, dice cuál de las cinco causas es y da
> la política **CORS** lista para pegar en Cloudflare. La causa raíz encontrada: el **paso de CORS
> nunca estuvo escrito** en la guía de despliegue — ya está en `docs/GUIA-RAILWAY-R2.md` §7 paso 7, y
> §9.1 es el detalle de las trampas.
