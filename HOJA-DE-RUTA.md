...
- **Fase activa:** F1 — Catálogos + Modelos. **`F1-E1` ✅, `F1-E1B` ✅, `F1-E2` ✅ y `F1-E3` ✅ hechas, verificadas y desplegadas en `prueba`** (F1-E3: 14-jun-2026). **Siguiente etapa: `F1-E4`** (Modelos: ficha + fotos R2 + BOM completo; ficha en [`docs/hoja-de-ruta/F1-etapas.md`](docs/hoja-de-ruta/F1-etapas.md)). **Rectificación 14-jun (D12/R15, rama `tarea/fusion-terceros`):** se eliminaron los catálogos `Maquilero` y `Cortador` — un tercero se da de alta una vez como **Proveedor** y marca sus servicios con casillas de roles (sin duplicar terceros).
...
| **F1 · Catálogos + Modelos** | 8 | 🔄 **en curso — F1-E1 ✅, F1-E1B ✅, F1-E2 ✅ y F1-E3 ✅ (en prueba); sigue F1-E4** |
