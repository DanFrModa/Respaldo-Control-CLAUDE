...
> | **0.102** ⬜ | **CONSUMO DE TELA POR CORTE Y POR MODELO** (nace del repaso 0.096) | 0.096 · Daniel 2-sep ✅ **Daniel 4-sep (§Post-F9.193, decisión 10):** se construye — es la base para saber si la merma real cuadra con el consumo teórico; hoy hay que ir color por color |
> | **0.103** ⬜ | **UBICACIÓN DEL MATERIAL EN EL ALMACÉN** (Daniel 2-sep: *«sí quiero que haya un lugar donde está ubicado. Principalmente para telas y avíos, pero podríamos dejarlo también para producto terminado»*) | 0.096 ✅ **CERRADA (3-sep):** *«de texto libre está bien. **Por ahora no un catálogo de posiciones** — si en algún momento se requiere lo hacemos»*. Texto libre por artículo × almacén; sin catálogo, sin validación, sin pantalla de administración |
