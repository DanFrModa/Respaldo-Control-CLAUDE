...
> **📊 Dónde va el programa — al 3-sep-2026, versión en `prueba` `0.093`.** De las **56 filas** numeradas: **33 ✅ cerradas** · **1 🔶 a medias** (0.082) · **1 ⏸️ aparcada** (0.087) · **21 ⬜ por hacer** (0.061, 0.072, 0.086, 0.096, 0.097, 0.099–0.114 salvo la 0.098). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
