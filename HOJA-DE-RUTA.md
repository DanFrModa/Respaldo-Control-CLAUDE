...
>
>
> **📊 Dónde va el programa — al 3-sep-2026, versión en `prueba` `0.092`.** De las **41 filas** numeradas: **32 ✅ cerradas** · **1 🔶 a medias** (0.082) · **1 ⏸️ aparcada** (0.087) · **7 ⬜ por hacer** (0.061, 0.072, 0.086, 0.096, 0.097, 0.106, 0.107). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
