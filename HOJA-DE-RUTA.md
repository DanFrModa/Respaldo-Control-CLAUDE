...
>
>
> **📊 Dónde va el programa — al 1-sep-2026, versión en `prueba` `0.078`.** De las **32 filas** numeradas: **16 ✅ cerradas** · **1 🔶 a medias** (0.073) · **15 ⬜ por hacer** (0.061, 0.068, 0.072, 0.075, 0.078, 0.079, 0.081, 0.083, 0.082, 0.084, 0.086, 0.087, 0.088, 0.089, 0.090). ⚠️ **Los huecos (0.061, 0.065, 0.066, 0.068, …) NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA, así que un número de plan puede salir con otro —o no salir— sin que nadie renumere nada. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
