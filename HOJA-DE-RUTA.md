...
>
>
> **📊 Dónde va el programa — al 1-sep-2026, versión en `prueba` `0.083`.** De las **36 filas** numeradas: **20 ✅ cerradas** · **2 🔶 a medias** (0.073, 0.079) · **14 ⬜ por hacer** (0.061, 0.068, 0.072, 0.075, 0.082, 0.084, 0.086, 0.087, 0.088, 0.089, 0.090, 0.091, 0.092, 0.094). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
