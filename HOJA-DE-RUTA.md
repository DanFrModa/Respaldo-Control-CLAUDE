...
> | **0.100** ⬜ | **EL TRASPASO DE PT DEJA RASTRO**: hoja de traspaso + **motivo obligatorio** (nace del repaso 0.096) | 0.096 · Daniel 2-sep |
> | **0.101** ⬜ | **LOS DOS AVISOS DE LA SALIDA DE TELA** (nace del repaso 0.096) | 0.096 · Daniel 2-sep |
> | **0.102** ⬜ | **CONSUMO DE TELA POR CORTE Y POR MODELO** (nace del repaso 0.096) | 0.096 · Daniel 2-sep |
...
> | **0.119** ⬜ | **LEER LA CONSTANCIA DE SITUACIÓN FISCAL** (Daniel: *«que el sistema lea toda la información… el sistema no se equivocará porque es un PDF y siempre es el mismo formato»* · *«les pediré siempre el **PDF original**, no escaneada. Si cambia el formato, te pido actualizarlo»*) | §Post-F9.186(l) ✅ **El lugar YA EXISTE**: `TipoArchivoProveedor` incluye **`CONSTANCIA`** ⇒ **Daniel puede cargarlas desde hoy**, no depende de ninguna fila. ⚠️ **Su premisa es correcta a medias, dicho y aceptado**: con el PDF original el texto se extrae exacto, pero **el riesgo no es leer mal una letra: es leer el CAMPO EQUIVOCADO** (escaneada = imagen; y si el SAT cambia el formato, un lector por posición **devuelve el campo de al lado sin trunar**). **Dos condiciones aceptadas**: mostrar lo leído antes de guardar la 1ª vez, y **decir «no pude leerla»** en vez de llenar a medias. 🔑 **Su plan de «si cambia me avisas» DEPENDE de la segunda.** ⭐ Y su regla del PDF original **se hace cumplir sola**: un escaneado no tiene texto ⇒ se rechaza |
...
> **📊 Dónde va el programa — al 4-sep-2026, versión en `prueba` `0.101`.** De las **69 filas** numeradas: **38 ✅ cerradas** · **1 🔶 a medias** (0.082) · **7 ⏸️ aparcadas a fase 2** (0.072, 0.086–0.087, 0.118, 0.122, 0.126–0.127) · **23 ⬜ por hacer en la V1** (0.061, 0.096–0.097, 0.099–0.104, 0.106–0.107, 0.109, 0.111, 0.113–0.114, 0.116–0.117, 0.119–0.121, 0.123–0.125). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
>
