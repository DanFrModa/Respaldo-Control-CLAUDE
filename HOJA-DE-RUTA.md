...
>
>
> **📊 Dónde va el programa — al 2-sep-2026, versión en `prueba` `0.088`.** De las **36 filas** numeradas: **24 ✅ cerradas** · **3 🔶 a medias** (0.068, 0.079, 0.082) · **9 ⬜ por hacer** (0.061, 0.072, 0.084, 0.086, 0.087, 0.088, 0.091, 0.092, 0.094). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
