...
> | **0.118** ⏸️ | ⭐ **EL DOCUMENTO DE FACTURACIÓN — «yo te digo qué facturarme»** (Daniel: *«nadie me factura si no le mando yo un documento con los datos con los que me tiene que facturar… **no al revés**. Y eso debe salir del sistema»*) | §Post-F9.186(k) ✅ **MEDIDO — es un IMPRESO, no un módulo**: `Proveedor` ya tiene `razonSocial`·`rfc`·`regimenFiscalSat`·`usoCfdiHabitual`·`codigoPostalExpedicion`, justo lo que pide un CFDI 4.0; los importes salen de la corrida (0.113). **El IVA va EXPLÍCITO**, no escondido como en el Excel de producción. ⚠️ **Proveedor sin RFC ⇒ NO se emite: hay que AVISAR cuál falta**, nunca inventarlo (REGLA 0-B: lo migrado viene incompleto). 📌 *Es lo que C&A le hace a él.* Depende de **0.113** y **0.110** ⏸️ **FASE 2 (Daniel, 4-sep-2026, §Post-F9.190):** *«ya quiero salir»* — hoy funciona en Excel o a mano y no bloquea operar. Ficha completa en la tabla *«Lo que espera a la fase 2»* |
...
> **📊 Dónde va el programa — al 4-sep-2026, versión en `prueba` `0.104`.** De las **82 filas** numeradas: **43 ✅ cerradas** · **1 🔶 a medias** (0.082) · **11 ⏸️ aparcadas a fase 2** (0.072, 0.086–0.087, 0.118, 0.122, 0.126–0.127, 0.133–0.135, 0.139) · **27 ⬜ por hacer en la V1** (0.061, 0.096–0.097, 0.099–0.104, 0.107, 0.109, 0.111, 0.114, 0.116–0.117, 0.119–0.121, 0.123–0.124, 0.128–0.132, 0.138, 0.140). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
>
