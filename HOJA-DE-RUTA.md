...
> **📊 Dónde va el programa — al 3-sep-2026, versión en `prueba` `0.097`.** De las **66 filas** numeradas: **35 ✅ cerradas** · **1 🔶 a medias** (0.082) · **1 ⏸️ aparcada** (0.087) · **29 ⬜ por hacer** (0.061, 0.072, 0.086, 0.096–0.097, 0.099–0.104, 0.106–0.109, 0.111–0.124). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
