...
> **📊 Dónde va el programa — al 4-sep-2026, versión en `prueba` `0.110`.** De las **83 filas** numeradas: **49 ✅ cerradas** · **1 🔶 a medias** (0.082) · **11 ⏸️ aparcadas a fase 2** (0.072, 0.086–0.087, 0.122, 0.126–0.127, 0.133–0.135, 0.139, 0.141) · **22 ⬜ por hacer en la V1** (0.061, 0.096–0.097, 0.099–0.104, 0.107, 0.111, 0.116–0.117, 0.119–0.121, 0.123, 0.128, 0.130–0.131, 0.138, 0.140). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
>
