...
>
>
> **📊 Dónde va el programa — al 2-sep-2026, versión en `prueba` `0.089`.** De las **37 filas** numeradas: **26 ✅ cerradas** · **4 🔶 a medias** (0.068, 0.079, 0.082, 0.084) · **7 ⬜ por hacer** (0.061, 0.072, 0.086, 0.087, 0.088, 0.094, 0.095). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
