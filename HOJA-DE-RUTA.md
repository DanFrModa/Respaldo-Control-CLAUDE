...
>
>
> **📊 Dónde va el programa — al 1-sep-2026, versión en `prueba` `0.081`.** De las **34 filas** numeradas: **19 ✅ cerradas** · **1 🔶 a medias** (0.073) · **14 ⬜ por hacer** (0.061, 0.068, 0.072, 0.075, 0.079, 0.082, 0.084, 0.086, 0.087, 0.088, 0.089, 0.090, 0.091, 0.092). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
