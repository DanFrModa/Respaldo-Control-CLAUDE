...
> | **0.082** ⬜ | ⏳ **LOS CINCO CABOS DE LAS PRENDAS INCOMPLETAS** (V1-E8k, §Post-F9.136), dejados abiertos **a propósito**; el detalle en `docs/hoja-de-ruta/V1-etapas.md` §V1-E8k → *«Lo que queda ABIERTO»*. El más visible: una incompleta de **prenda ya terminada** se queda viva en **Tránsito para siempre** —el recibo sólo devuelve primeras y segundas— y ese saldo **sólo se limpia con un movimiento manual de PT**. 🔴 **NECESITA LA PALABRA DE DANIEL antes de construirse**: darle salida automática **sería inventar una merma que él no pidió** | §Post-F9.136 |
>
