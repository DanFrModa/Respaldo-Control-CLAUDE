...
> | **0.137** ⬜ | **NADIE VERIFICA QUE EL ALMACÉN SEA DEL TIPO CORRECTO** (repaso 0.096, «otras cosas») | §Post-F9.193 El desplegable acota, pero **nada impide meter producto terminado en la bodega de telas**: la validación vive sólo en pantalla. ⇒ regla en el dominio (A1): cada movimiento exige que el almacén admita ese tipo de artículo; prueba de 400 con almacén ajeno; sin migración. **V1** (chica) |
...
> **📊 Dónde va el programa — al 4-sep-2026, versión en `prueba` `0.103`.** De las **82 filas** numeradas: **42 ✅ cerradas** · **1 🔶 a medias** (0.082) · **11 ⏸️ aparcadas a fase 2** (0.072, 0.086–0.087, 0.118, 0.122, 0.126–0.127, 0.133–0.135, 0.139) · **28 ⬜ por hacer en la V1** (0.061, 0.096–0.097, 0.099–0.104, 0.107, 0.109, 0.111, 0.114, 0.116–0.117, 0.119–0.121, 0.123–0.124, 0.128–0.132, 0.137–0.138, 0.140). ⚠️ **Los huecos NO se rellenan**: la fila numera el PLAN y la entrega numera la LLEGADA. Ver *«Cómo se numeran»* en `HISTORIAL-DE-VERSIONES.md`.
>
