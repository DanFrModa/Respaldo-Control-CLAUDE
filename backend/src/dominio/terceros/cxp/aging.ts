...
export const LIMITES_AGING_CXP = LIMITES_AGING_DEFECTO;

/**
 * Clasifica un cargo de CxP en su cubeta por sus DÍAS DE ATRASO, con los {@link LIMITES_AGING_CXP}.
 * ≤ 0 → corriente; 1..30 → d1a30; 31..60 → d31a60; > 60 → mas60.
 */
export function cubetaPorAtraso(diasAtraso: number): keyof CubetasAging {
  return cubetaPorAtrasoComun(diasAtraso, LIMITES_AGING_CXP);
}
