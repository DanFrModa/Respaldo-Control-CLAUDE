...
> **Estado:** 🔄 EN CURSO — **F5-E1 ✅ y F5-E2 ✅ (22-jun-2026)**; decisiones de fase (a–h) cerradas con Daniel (`Documentacion_MJD/DECISIONES.md` §"Decisiones de negocio de F5"). Resto E3–E7 ⬜.
...
## F5-E3 · Motor RC parte 1 (backend): infraestructura de jobs + datos de la ruta viva + duraciones + generación y ajuste de ruta — ⬜ pendiente
...
## F5-E4 · Motor RC parte 2 (backend): CPM en pg-boss + captura de avance + checklist + semáforo y EnRiesgo — ⬜ pendiente
...
## F5-E5 · Pantallas de operación: Programar RC, bandeja de tareas con semáforo y alertas (PC+móvil) y RC por orden — ⬜ pendiente
