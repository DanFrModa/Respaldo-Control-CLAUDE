...
> **Estado:** 🔄 EN CURSO — **F5-E1 ✅, F5-E2 ✅, F5-E3 ✅ y F5-E4 ✅ (22-jun-2026)** — el motor completo (datos + duraciones + generación + CPM + captura + semáforo) está construido; decisiones de fase (a–h) cerradas con Daniel (`Documentacion_MJD/DECISIONES.md` §"Decisiones de negocio de F5"). Resto E5–E7 ⬜.
