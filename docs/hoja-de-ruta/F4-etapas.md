...
## F4-E1 · Kardex de telas y avíos (lotes D5) + pantallas de inventario — ⬜ pendiente
...
## F4-E2 · Órdenes de compra: captura, autorización (móvil), cancelación, consultas e impresos — ⬜ pendiente
...
## F4-E3 · Recepción de compras (R7): lotes D5, entrada al kardex y evento para la RC — ⬜ pendiente
...
## F4-E4 · Explosión R3, generar OC desde la explosión y tablero 'qué tengo / qué falta' (R7) — ⬜ pendiente
