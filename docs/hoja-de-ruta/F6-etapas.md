...
>
> **Pendiente de confirmar con Daniel (NO bloquea — anotado para E3 o ajuste posterior):** (1) la reclasificación mueve existencia del **modelo completo** entre Primeras/Segundas (no acotada a la orden/muestra auditada; inherente al PT que se lleva por modelo×color×talla, con guarda no-negativo); (2) hoy se permite reclasificar una auditoría `no_calificado` (sin veredicto) — ¿debe exigir reprobada primero?
>
