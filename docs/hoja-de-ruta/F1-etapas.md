...
- Tabla de mapeo texto→idColor persistida + mapeo tela vieja→Tela unificada + mapeo maquilero/estampador→Maquilero (los reutilizan E7/F2/F4/F8)
