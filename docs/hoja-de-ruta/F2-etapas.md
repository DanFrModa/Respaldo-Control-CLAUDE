...
> **Estado:** 🔄 EN CURSO — `F2-E1` ✅ (en `prueba`, PR #46) · `F2-E2` 🔄 construido + aprobado por reviewer, PR a `prueba` (pendiente verif. de Gabriel, 16-jun-2026); siguen E3–E5.
