...
**Siguiente paso:** R5 (Desarrollo: re-vestir F8 + campos del precosteo) — la retoma **Gabriel con Opus** en sesión nueva (fin de la corrida nocturna Fable; ver regla 5c).
