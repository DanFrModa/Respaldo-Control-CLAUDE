...
- **Recomendaciones adicionales (para que Daniel elija cuáles agregar):** cumplimiento de **entrega al cliente** (on-time delivery, el KPI norte) + su tendencia; **tiempo de ciclo** (lead time OP→entrega); **carga vs desempeño** (¿el score bajo es por sobrecarga?); **riesgo por cliente**; **alertas predictivas** (órdenes que VAN a atrasarse por holgura proyectada negativa aunque hoy no lo estén).
